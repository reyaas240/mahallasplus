        ...
        <section className="relative pt-32 pb-48 overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 px-4">
              ...
              <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || 'your-number'}?text=Hi! I want to register my Mahalla`} className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 md:px-10 md:py-5 rounded-[24px] text-base md:text-lg font-black text-emerald-600 bg-white border-2 border-emerald-100 hover:bg-emerald-50 transition-all uppercase tracking-widest group">

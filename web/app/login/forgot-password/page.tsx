...
import { Users, AlertCircle, ChevronLeft, Mail, Loader2, CheckCircle2 } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-[440px] animate-in fade-in zoom-in duration-500">
        ...
        <div className="backdrop-blur-xl bg-white/70 border border-white/40 shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-[32px] p-8 md:p-10">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 mt-2 font-medium">Enter your email to receive a reset link</p>
          </div>
            ...
            <div className="text-center space-y-6 animate-in fade-in zoom-in duration-500">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-slate-500 leading-relaxed">
                  If an account exists for {email}, a reset link will be sent. The platform admin has also been notified.
                </p>
              </div>
              <Link 
                href="/login"

            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className={`space-y-6 animate-in fade-in slide-in-from-right-4 duration-500 ${step === 1 ? 'block' : 'hidden'}`}>
                <div className="space-y-4 mb-8">
                  <h2 className="text-3xl font-black text-slate-900 tracking-tight">Let's Get Started</h2>
                  <p className="text-slate-500 font-medium leading-relaxed">
                    Join the digital backbone of modern Mahallas. Choose your preferred registration method below.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <a 
                    ...
                    className="flex items-center justify-between p-6 rounded-3xl bg-emerald-50 border-2 border-emerald-100 hover:bg-emerald-100/50 transition-all group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-sm font-black text-emerald-900 uppercase tracking-widest">Register via WhatsApp</div>
                        <div className="text-[11px] font-bold text-emerald-600/80">Fastest, no forms required</div>
                      </div>
                    </div>
                  ...
                  <div className="relative py-4">
                    ...
                    <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest"><span className="bg-white px-4 text-slate-400">Or use web form</span></div>
                  </div>
                </div>
